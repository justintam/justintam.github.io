...
(function (global, factory) {
  ...
  */
  ...
  function arraylike(data) {
    return _typeof2(data) === "object" && "length" in data ? data // Array, TypedArray, NodeList, array-like
  ...
  var TextBox = /*#__PURE__*/function (_BaseClass) {
    ...
    */
    function TextBox() {
      ...
      _this3._ariaHidden = constant("false");
      _this3._delay = 0;
      _this3._duration = 0;
      ...
      _this3._fontColor = constant("black");
      _this3._fontFamily = constant(["Roboto", "Helvetica Neue", "HelveticaNeue", "Helvetica", "Arial", "sans-serif"]);
      _this3._fontMax = constant(50);
      _this3._fontMin = constant(8);
      _this3._fontOpacity = constant(1);
      _this3._fontResize = constant(false);
      _this3._fontSize = constant(10);
      _this3._fontStroke = constant("transparent");
      _this3._fontStrokeWidth = constant(0);
      _this3._fontWeight = constant(400);
      ...
      _this3._maxLines = constant(null);
      _this3._on = {};
      _this3._overflow = constant(false);
      _this3._padding = constant(0);
      _this3._pointerEvents = constant("auto");
      _this3._rotate = constant(0);
      ...
      _this3._textAnchor = constant("start");
      _this3._verticalAlign = constant("top");
      ...
      value: function render(callback) {
        ...
        var boxes = this._select.selectAll(".d3plus-textBox").data(this._data.reduce(function (arr, d, i) {
          ...
          var fS = resize ? _this4._fontMax(d, i) : _this4._fontSize(d, i),
              ...
              wrapResults;
          var style = {
            "font-family": fontExists$1(_this4._fontFamily(d, i)),
            "font-size": fS,
  ...
  */
  ...
  exports.fontExists = fontExists$1;
