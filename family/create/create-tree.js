...
function firstNode() {
  return [{id: '0', rels: { spouses: ['1'], children: ['2'] }, data: {fn: 'Unknown', ln: 'Tan', birth: '?', death: '?', label: '譚', gender: 'M',
	  desc: '',
	  ...
	  {id: '1', rels: { spouses: ['0'], children: ['2'] }, data: {fn: 'Unknown', ln: 'Tan', birth: '?', death: '?', label: '譚', gender: 'F',
	  desc: '',
      image: 'https://static8.depositphotos.com/1009634/988/v/950/depositphotos_9883921-stock-illustration-no-user-profile-picture.jpg'}},
	  {id: '2', rels: { spouses: ['3'], children: ['4'] }, data: {fn: 'Hongzhi', ln: 'Tan', birth: '901', death: '974', label: '譚宏帙', gender: 'M',
	  ...
	  {id: '3', rels: { spouses: ['2'], children: ['4'] }, data: {fn: 'Unknown', ln: 'Tan', birth: '?', death: '?', label: '譚', gender: 'F',
	  desc: '',
      image: 'https://static8.depositphotos.com/1009634/988/v/950/depositphotos_9883921-stock-illustration-no-user-profile-picture.jpg'}},
	  {id: '4', rels: {}, data: {fn: 'Hong', ln: 'Tan', birth: '930', death: '1000', label: '譚洪', gender: 'M',
	  desc: '',
      image: 'https://p3-sdbk2-media.byteimg.com/tos-cn-i-xv4ileqgde/2c9ac1a536c74c7fa588e5f99fca4b33~tplv-xv4ileqgde-resize-w:750.image'}},
	  ]
}
